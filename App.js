    ...
    <ScrollView>
      <View style={styles.Principal}>
        <View style={{ marginTop: 100, marginLeft: 30 }}>
          ...
          >
            Qual instrumento deseja estudar?
          </Text>
        </View>
        <TextInput
          style={{
          ...
          placeholder="Busque por instrumento"
        ...
        />
        <ScrollView
          contentContainerStyle={{ flexDirection: "row", margin: 20 }}
          horizontal={true}
          style={{}}
        >
        ...
        <View style={{}}>
          <Text style={{ color: "white", margin: 30, marginBottom: 10 }}>
            Próxima aula
          </Text>
          ...
          >
            ...
            <Text style={{ position: "relative", left: 170, bottom: 135 }}>
              Data_da_aula
            </Text>
            <Text
              style={{
        ...
        <View style={styles.barra_navegacao}>
          <TouchableOpacity
            style={{
              ...
              width: 120,
              borderWidth: 2,
              borderBottomColor: select == 1 ? "#15ddf7" : null,
            }}
            onPress={() => {
              setSelect(1);
          ...
          <TouchableOpacity
            style={{
              ...
              width: 120,
              borderWidth: 2,
              borderBottomColor: select == 2 ? "#15ddf7" : null,
            }}
            onPress={() => {
              setSelect(2);
            }}
          ...
          <TouchableOpacity
            style={{
              ...
              width: 120,
              borderWidth: 3,
              borderBottomColor: select == 3 ? "#15ddf7" : null,
            }}
            onPress={() => {
              setSelect(3);
          ...
          >
            <Image
              source={require("./assets/discurso.png")}
              resizeMode="contain"
              style={{ height: 25 }}
            />
...
function SelectChat({ navigation }) {
  ...
  return (
    <ScrollView>
      ...
      >
        <TouchableOpacity
          style={styles.chat_instrutor}
          onPress={() =>
            navigation.navigate("TelaChat", { prof: "TiagoSilva" })
          }
        >
        ...
        <TouchableOpacity
          style={styles.chat_instrutor}
          onPress={() =>
            navigation.navigate("TelaChat", { prof: "GeorgeCarlos" })
          }
        >
        ...
        <TouchableOpacity
          style={styles.chat_instrutor}
          onPress={() =>
            navigation.navigate("TelaChat", { prof: "MarinaBorges" })
          }
        >
        ...
        <TouchableOpacity
          style={styles.chat_instrutor}
          onPress={() =>
            navigation.navigate("TelaChat", { prof: "MarcosSousa" })
          }
        >
        ...
        <TouchableOpacity
          style={styles.chat_instrutor}
          onPress={() =>
            navigation.navigate("TelaChat", { prof: "AndreMarcos" })
          }
        >
...
function TelaBoasVindas({ navigation }) {
  return (
    <View style={styles.TelaInicial}>
      <Image
        source={require("./assets/Musico3.png")}
        style={{ position: "absolute", bottom: -220, width: 400 }}
      />
      ...
      <Text
        style={{ position: "absolute", bottom: 130, fontSize: 20, width: 300 }}
      >
        Encontre os melhores profissionais da sua região e agende suas aulas
      </Text>
      <TouchableOpacity
    ...
    */
    <NavigationContainer>
      <Navigator screenOptions={{ headerShown: false }}>
        ...
        <Screen name="TelaMapa" component={Map} />
      </Navigator>
    </NavigationContainer>
  );
}
